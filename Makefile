...
objects = main.o title_screen.o game.o result_screen.o font_score.o\
	...
	pause_msg.o text_lynxjam.o text_press.o text_gfx.o text_code.o text_gameover.o text_score.o text_hiscore.o text_version.o text_thx.o


$(target) : $(objects)
	$(CL) -t $(SYS) -o $@.lnx -m town_patrol.map $(objects) lynx.lib
	$(CL) -t $(SYS) --config lynx-bll.cfg -o $@.o -m town_patrol.map $(objects) lynx.lib 
